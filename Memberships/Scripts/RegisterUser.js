$(function () {
    ...
    let hasAcceptTerm = false;
    var registerUserCheckBox = $('#AceitarTermoDeUso').click(onToggleRegisterUserDisabledClick);   
        ...
        $.post(url, { __RequestVerificationToken: antiforgery, email: email, name: name, password: pwd, acceptUserAgreement: true },
            function (data) {
                ...
                if (hasErrors == true) {
                    ...
                    registerUserCheckBox = $('#AceitarTermoDeUso').click( onToggleRegisterUserDisabledClick);
