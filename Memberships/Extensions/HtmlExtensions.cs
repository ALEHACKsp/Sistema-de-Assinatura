...
namespace Memberships.Extensions
{
    public static class HtmlExtensions
    {
        ...
        public static MvcHtmlString GlyphLink(this HtmlHelper htmlHelper,string controller, 
            string action, string text,string glyphicon, string cssClasses = "", string id = "",
